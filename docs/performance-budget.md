...
- Browser release tests use the explicit `renderFps=12` diagnostic cap so software WebGL cannot starve the unchanged 20 Hz authority clock; normal play remains display-rate uncapped.
