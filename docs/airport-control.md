...
The current API version is `2.21.0`; snapshots use schema version `23`.
...
Snapshot schema 23 adds route-aware fuel plans, aircraft fuel/range specifications, 001–360 heading/cardinal telemetry, carrier-market distance provenance, and contrail presentation diagnostics while retaining schema 22 controller handoffs, coordination workload, and ownership state.
