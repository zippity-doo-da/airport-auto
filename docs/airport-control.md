...
The current API version is `2.19.0`; snapshots use schema version `21`.
...
Snapshot schema 21 adds focused/group selection state and atomic grouped-command support while retaining schema 20 staged route previews, physical conflict warnings, pending/accepted/rejected readback state, and route-clearance provenance.
