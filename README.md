...
- A local protocol-1.0 browser API and `BroadcastChannel` bridge with JSON Schemas for 85 commands, explicit station authority, structured results, causal command/event IDs, replay audit data, and API-2.x compatibility for playtests and controller agents.
