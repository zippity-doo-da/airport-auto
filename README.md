...
- A separate, additive Fighter Archive at `fighters.html` browses 195 cataloged fighter families from World War II through current and developmental jets. Lightweight procedural archetypes cover the broad catalog, while aircraft-specific F-35A, J-20, F-22A, and MiG-35 models establish the detailed-model benchmark. The archive filters by era, design origin, and propulsion, keeps only one model resident, and does not place military traffic into the civilian airport simulation.
- A separate runway-free Flight Playground at `flight-playground.html` puts the detailed F-35A and J-20 airborne together over procedural open country. Fixed-step, analytically sampled formation, break/rejoin, and staggered programs drive smooth orientation, bank, spacing, and representative airspeed; cinematic, chase, wide, and touch-friendly free cameras remain separate from the airport simulation.
- A peaceful Heritage Flight at `heritage-flight.html` flies the detailed F-35A with aircraft-specific F4U-4 Corsair, P-51D Mustang, and F-86F Sabre models. Museum-scale dimensions, the Corsair's inverted gull wing, the Mustang's laminar wing/bubble canopy/ventral radiator, and the Sabre's nose intake and 35-degree swept wing replace generic archive silhouettes. Diamond, echelon, line-abreast, and gentle break/rejoin programs share a fixed-step formation loop with director, close-up, wide, and free cameras.
- A separate AI Dogfight Lab at `dogfight.html` reuses the four detailed modern fighters in a deterministic, fixed-step combat arena. Either side can select an F-35A, J-20, F-22A, or MiG-35, while an on-demand reference separates sourced public specifications from deliberately compressed arena physics. Selectable full-combat, guns-only, and custom rules combine with independent Green, Experienced, and Ace pilots. Each pilot has a game-scale sustained/peak-G envelope, reaction and aim differences, fatigue-aware G limiting, and a qualified vocabulary of 14 named maneuvers. High-altitude combat over a 36–48 km soft-bounded theater is the default; medium and terrain-aware low bands, five procedural theaters, four openings, cloud/haze/visibility presets, and wind are selectable without exposing a hard world edge. The autonomous fighters avoid airframe and terrain collisions, score continuous rounds, and remain independent from both the peaceful playground and civilian airport runtime.
