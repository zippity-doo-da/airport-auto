...
- [x] Add condition-driven exhaust, condensation, upper-scope contrails, tire smoke, runway spray, deicing spray, and grounded/airborne shadow behavior without enabling decorative effects when the physical state does not warrant them.
