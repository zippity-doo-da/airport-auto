...
- [x] Assisted ATC proposes one safe clearance at a time, explains why, and waits for approval; compressed arrival sequences can receive a timed published Approach hold, and early arrivals can receive a conservative published-route direct-to through the typed command path.
