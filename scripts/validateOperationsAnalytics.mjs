...
assert(acceptedClearance?.schemaVersion === 3 && acceptedClearance.channel === 'data' && acceptedClearance.aircraftSupport === 'simulated-data-comm', 'digital-clearance analytics omitted capability metadata');
