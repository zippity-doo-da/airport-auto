...
assert(CONTROL_API_VERSION === '2.38.0', 'control API version changed unexpectedly');
assert(CONTROL_SNAPSHOT_SCHEMA_VERSION === 40, 'snapshot schema version changed unexpectedly');
