...
assert(fixedStepSnapshot.schemaVersion === 18 && fixedStepSnapshot.state.operationTimeOffsetMinutes === 180, 'fixed-step snapshot omitted the operation clock offset');
