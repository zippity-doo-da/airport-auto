...
assert(fixedStepSnapshot.schemaVersion === 17 && fixedStepSnapshot.state.operationTimeOffsetMinutes === 180, 'fixed-step snapshot omitted the operation clock offset');
